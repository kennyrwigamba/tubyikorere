  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:font-medium data-[state=inactive]:bg-transparent dark:data-[state=active]:bg-card dark:data-[state=active]:shadow-sm",
